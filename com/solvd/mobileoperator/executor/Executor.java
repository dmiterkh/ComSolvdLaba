...
//			badEmployeeIndex = Integer.parseInt(indexArray[0]);
...
//			indexArray = newIndex.split(" ");
//			expiriencedApplicantIndex = Integer.parseInt(indexArray[0]);
		...
		int firstIndex = employeeIndex;
		int secondIndex = employeeIndex + badEmployeeIndex;
		int thirdIndex = employeeIndex + badEmployeeIndex + bossIndex;
		int fourthIndex = employeeIndex + badEmployeeIndex + bossIndex + expiriencedApplicantIndex;
        ...
        if ("y".equals(index)) {
         	for(int i = secondIndex; i < thirdIndex; i++) {
         		System.out.println(colleagueAr1.getListOfStaff().get(i).toString());
         		System.out.println("======");
			}
 		} else {
        ...
        if ("y".equals(index)) {
         	for(int i = thirdIndex; i < fourthIndex; i++) {
         		System.out.println(colleagueAr1.getListOfStaff().get(i).toString());
         		System.out.println("======");
			}
 		} else {
		...
		firstIndex = employeeIndex;
		secondIndex = employeeIndex + badEmployeeIndex;
		...
		firstIndex = mobilePhoneUserIndex;
		secondIndex = mobilePhoneUserIndex + mobileInternetUserIndex;
		thirdIndex = mobilePhoneUserIndex + mobileInternetUserIndex + homeInternetUserIndex;
